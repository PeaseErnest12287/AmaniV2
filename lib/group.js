const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x47ed60) {
       return await _0x466dd8.reply("*_Uhh Please i do not have a link, provide group link_*");
     }
     ...
     await _0x466dd8.error(_0x5d3484 + "\n\ncommand: join", _0x5d3484, "*_Can't Join,sorry  Group Id not found, Sorry!!_*");
   }
 });
 smd({
   cmdname: "newgc",
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country  code without the plus plaese. Example: .kik 212*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code without tha plus. Example: .num 91*");
     }
