...
global.anitav4 = process.env.BOT_NAME || "AMANI-𝐕2";
global.ownername = process.env.OWNER_NAME || "Pease Ernest";
global.packname = process.env.PACK_NAME || "AMANI-𝐕2";
global.author = process.env.AUTHOR || "PEASE ERNEST";
global.channelname = process.env.CHANNEL_NAME || "PEASE ERNEST";
